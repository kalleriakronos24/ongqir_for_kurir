                        ...
                        <>
                            <ScrollView style={{ flex: 1 }} scrollEventThrottle={16} refreshControl={<RefreshControl refreshing={false} onRefresh={onRefresh} />}>

                                {
                                    count === 0 ? (
                                        <View style={{ justifyContent: 'center', alignItems: 'center', flex: 1 }}>
                                            <Text style={{ fontSize: 17, fontWeight: 'bold', letterSpacing: .6, textAlign: 'center' }}>tidak ada riwayat orderan ditemukan. :(</Text>
                                        </View>
                                    ) : (
                                            <View style={{ flex: 1, backgroundColor: 'white', paddingTop: StatusBar.currentHeight }}>
                                ...
                                <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 20 }}>{formatRupiah(String(orderItems!.map((v) => v.ongkir).reduce((a, b) => a + b, 0) * (15 / 100)), 'Rp. ')}</Text>
